...
def get_login_form(message):
   ...
   <form action="" method="post">
       <p>Enter your username: <input type=text name=user>
       <p>Enter your password: <input type=password name=pass>
       <p>Submit<input type=submit value=Login>
   </form>
   '''.format(message))
...
def login():
    if request.method == 'POST':
        ...
        if username in user_dict and user_dict[username] == password:
            ...
            return Response('Here is your inbox')
        else:
            return get_login_form('Please try again')
    else:
        return get_login_form('Welcome to fake Gmail! Please login')
